...
class app():
    def __init__(self):
        ...
        self.repo_name = "AluraRenamer"
        self.api_url = f"https://api.github.com/repos/{self.repo_owner}/{self.repo_name}/releases/latest"
        self.headers = {"Accept": "application/vnd.github+json"}
        self.current_version = float(double(Utils.version.lstrip("V")))    
    ...
    def initRequest(self):
        ...
        try:
            ...
            Utils.LogError(func="Atualizações",mensagem=f"Erro ao buscar por atualizações: {e}")
